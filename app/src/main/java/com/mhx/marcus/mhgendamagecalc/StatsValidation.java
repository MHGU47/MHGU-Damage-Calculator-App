...
public class StatsValidation {
    ...
    public boolean isValid(){//Used to check whether the inputted values are true.
        return isValidAtk() && isValidAffinity() && isValidElm();
    }

    public boolean isValid_DB(){//Used to check whether the inputted values are true.
    ...
    public boolean isValidAtk(){//Used to check whether the inputted attack value is true.
        return PhysAtk >= 0;
    }

    public boolean isValidElm(){//Used to check whether the element and element type inputted are true.
        boolean Valid = true;
    ...
    public boolean isValidSubElm(){//Used to check whether the inputted sub element for DB is true.
        boolean Valid = true;
