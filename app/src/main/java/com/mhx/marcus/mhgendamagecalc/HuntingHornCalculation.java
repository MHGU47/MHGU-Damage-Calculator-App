...
public class HuntingHornCalculation extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    float[] SharpModAtk = {0.5f, 0.75f, 1, 1.05f, 1.2f, 1.32f, 1.44f};
    ...
    Float[] GuildStyleMotion =  {0.33f, 0.3f, 0.27f,/*space*/0.3f, 0.3f, 0.27f,
            /*space*/0.45f, 0.6f, 0.1f, 0.35f, /*space*/0.2f, 0.3f, 0.3f,/*space*/ 0.68f, 0.68f,
            /*space*/0.7f, 1.02f, /*space*/0.36f};
    String[] GuildStyleNames = {"Draw Attack - 20, 20","Forward Slam - 20, 15","   -After an Attack - 20, 15",
            "Left Swing - 20, 15","Right Swing - 20, 15","Double Swing (2 hits) - 14, 14",
            "Backward Slam - 25, 20","Super Slam (2 hits) - 20, 55","Handle Hit","Idle Recital - 22, 22",
            "Forward Recital - 15, 22","Backward Recital - 22, 25","Forward Encore - 22, 25",
            "Left Encore (2 hits) - 44, 49","Right Encore (2 hits) - 44, 49",
            "2-Note Backward Encore (2 hits) - 50, 44","3-Note Backward Encore (3 hits) - 69, 71",
            "Jump Attack - 20, 20"};

    Float[] StrikerStyleMotion = {0.33f, 0.3f, 0.3f, /*space*/0.6f, 0.1f, 0.35f, 0.2f,
            /*space*/0.3f, 0.3f, 0.68f, /*space*/0.68f, 0.7f, /*space*/1.02f, 0.36f};
    String[] StrikerStyleNames = {"Draw Attack - 20, 20","Left Swing - 20, 15","Right Swing - 20, 15",
            "Super Slam (2 hits) - 20, 55","Handle Hit","Idle Recital - 22, 22","Forward Recital - 15, 22",
            "Backward Recital - 22, 25","Forward Encore - 22, 25","Left Encore (2 hits) - 44, 49",
            "Right Encore (2 hits) - 44, 49","2-Note Backward Encore (2 hits) - 50, 44",
            "3-Note Backward Encore (3 hits) - 69, 71","Jump Attack - 20, 20"};

    Float[] AerialStyleMotion = {0.33f, 0.3f, 0.27f,/*space*/0.3f, 0.3f, 0.45f, 0.6f,
            /*space*/0.1f, 0.35f, 0.2f, 0.3f,/*space*/0.3f, 0.68f, 0.68f,/*space*/0.7f, 1.02f,
            /*space*/0.24f};
    String[] AerialStyleNames = {"Draw Attack - 20, 20","Forward Slam - 20, 15","   -After an Attack - 20, 15",
            ...
            "Forward Encore - 22, 25","Left Encore (2 hits) - 22, 22","Right Encore (2 hits) - 22, 22",
            "2-Note Backward Encore (2 hits) - 50, 44","3-Note Backward Encore (3 hits) - 69, 71",
            "Aerial Attack (2 hits) - 20, 20"};
    ...
    Float[] ValorStyleMotion =  {0.33f, 0.3f, 0.27f,/*space*/0.3f, 0.3f, 0.27f,
            ...
            /*space*/0.7f, 1.02f, /*space*/0.6f, 0.36f};
    String[] ValorStyleNames = {"Draw Attack - 20, 20","Forward Slam - 20, 15","   -After an Attack - 20, 15",
            "Left Swing - 20, 15","Right Swing - 20, 15","Valor Stance - Double Swing\n(2 hits) - 14, 14",
            "Backward Slam - 25, 20","Super Slam (2 hits) - 20, 55","Handle Hit","Idle Recital - 22, 22",
            "Forward Recital - 15, 22","Backward Recital - 22, 25","Valor Step Recital (2 hits) - 30, 30",
            "Forward Encore - 22, 25","Left Encore (2 hits) - 44, 49","Right Encore (2 hits) - 44, 49",
            "2-Note Backward Encore (2 hits) - 50, 44","3-Note Backward Encore (3 hits) - 69, 71",
            "Valor Step Encore (2 hits) - 40, 40","Jump Attack - 20, 20"};

    Float[] AlchemyStyleMotion =  {0.33f, 0.3f, 0.27f, /*space*/0.3f, 0.3f, 0.45f, 0.6f,
            /*space*/0.1f, 0.35f, 0.2f, 0.3f,/*space*/0.3f, 0.68f, 0.68f,/*space*/0.7f, 1.02f,
            /*space*/0.36f};
    String[] AlchemyStyleNames = {"Draw Attack - 20, 20","Forward Slam - 20, 15","   -After an Attack - 20, 15",
            "Left Swing - 20, 15","Right Swing - 20, 15","Backward Slam - 25, 20","Super Slam (2 hits) - 20, 55",
            "Handle Hit","Idle Recital - 22, 22","Forward Recital - 15, 22","Backward Recital - 22, 25",
            "Forward Encore - 22, 25","Left Encore (2 hits) - 44, 49","Right Encore (2 hits) - 44, 49",
            "2-Note Backward Encore (2 hits) - 50, 44","3-Note Backward Encore (3 hits) - 69, 71",
    ...
    Float[] SonicSmash = {0.1f, 80f, 0.1f, 100f, 0.2f, 150f};
    Float[] ChosenHunterArt;
    String[] HunterArtsLevels = {"Level I", "     -Fixed Damage", "Level II", "     -Fixed Damage",
            "Level III", "     -Fixed Damage"};

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hunting_horn_calculation);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(ArtText.equals("Sonic Smash")){
            getHunterArt("Sonic Smash");
        }
        ...
        Calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                InputMethodManager inputManager = (InputMethodManager)
                        getSystemService(HuntingHornCalculation.this.INPUT_METHOD_SERVICE);
                ...
                int Counter;
                int Banner;
                TextViewIDsAttacks = new String[]{"HHAttack_1", "HHAttack_2", "HHAttack_3",
                        "HHAttack_4", "HHAttack_5", "HHAttack_6", "HHAttack_7",
                        "HHAttack_8", "HHAttack_9", "HHAttack_10", "HHAttack_11",
                        "HHAttack_12", "HHAttack_13", "HHAttack_14", "HHAttack_15", "HHAttack_16",
                        "HHAttack_17", "HHAttack_18", "HHAttack_19", "HHAttack_20", "HHAttack_21",
                        "HHAttack_22", "HHAttack_23"};

                TextViewIDsNames = new String[]{"HHAttack_1_Name", "HHAttack_2_Name", "HHAttack_3_Name",
                        "HHAttack_4_Name", "HHAttack_5_Name", "HHAttack_6_Name", "HHAttack_7_Name",
                        "HHAttack_8_Name", "HHAttack_9_Name", "HHAttack_10_Name", "HHAttack_11_Name",
                        "HHAttack_12_Name", "HHAttack_13_Name", "HHAttack_14_Name", "HHAttack_15_Name",
                        "HHAttack_16_Name","HHAttack_17_Name","HHAttack_18_Name","HHAttack_19_Name",
                        "HHAttack_20_Name","HHAttack_21_Name","HHAttack_22_Name","HHAttack_23_Name"};

                AllTextViewIDs = new String[]{"HHAttack_1_Name", "HHAttack_2_Name", "HHAttack_3_Name",
                        "HHAttack_4_Name", "HHAttack_5_Name", "HHAttack_6_Name", "HHAttack_7_Name",
                        "HHAttack_8_Name", "HHAttack_9_Name", "HHAttack_10_Name", "HHAttack_11_Name",
                        "HHAttack_12_Name", "HHAttack_13_Name", "HHAttack_14_Name", "HHAttack_15_Name",
                        "HHAttack_16_Name", "HHAttack_17_Name","HHAttack_18_Name","HHAttack_19_Name",
                        "HHAttack_20_Name","HHAttack_21_Name","HHAttack_22_Name","HHAttack_23_Name",
                        "HHAttack_1", "HHAttack_2", "HHAttack_3", "HHAttack_4", "HHAttack_5",
                        "HHAttack_6", "HHAttack_7", "HHAttack_8", "HHAttack_9", "HHAttack_10",
                        "HHAttack_11", "HHAttack_12", "HHAttack_13", "HHAttack_14", "HHAttack_15",
                        "HHAttack_16","HHAttack_17", "HHAttack_18", "HHAttack_19", "HHAttack_20",
                        "HHAttack_21", "HHAttack_22", "HHAttack_23"};
                ...
                if (!ChosenArt.equals("-None-")){
                    MotionCheck = 1;
                    ChosenHunterArt = SonicSmash;
                    HunterArtElementCheck = new int[] {2, 1, 2, 1, 4, 1};
                }
                //-End-
                ...
                TextView Damage = (TextView) findViewById(R.id.DamageInputHH);
                TextView Element = (TextView) findViewById(R.id.ElementInputHH);
                TextView Affinity = (TextView) findViewById(R.id.AffinityInputHH);
                ...
                class.*/
                M = new MonsterCalculation(HuntingHornCalculation.this,
                ...
                M.getHitzones(HuntingHornCalculation.this, ChosenElement, Skills, WeaknessExploitCheck.isChecked());
                ...
                for (int i = 0; i < MotionGroup[MotionCheck].length; i++) {
                    ...
                    float TrueAttack;
                    if (!ChosenArt.equals("-None-")){
                        if(HunterArtsLevels[i].contains("Fixed")){
