...
public class LanceCalculation extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    RadioButton EnragedGuardRed, EnragedGuardYellow, EnragedGuardOrange, NoEnragedGuardAura;
    ...
    Float[] GuildStyleMotion =  {0.27f, 0.2f, 0.22f, 0.45f, 0.2f, 0.2f, 0.2f, 0.22f, 0.6f, 0.66f,
            0.5f, 1.5f, 0.14f, 0.16f, 0.5f, 0.5f, 0.5f, 0.3f};
    String[] GuildStyleNames = {"Draw Attack","Forward Thrusts","Upward Thrusts","Strong Thrust (3 hits)",
            "Swipe","Thrust from Shield","Counter (Forward)","Counter (Upward)","Counter (Counter Hit - Forward)",
            "Counter (Counter Hit - Upward)","      - Full Charge","      - Full Charge (Counter Hit)",
            "Shield Smack - 27 KO","Running Charge (Per hit)","     -Finisher","     -Jumping Finisher",
            "     -Turn Around Finisher","Jump Attack"};

    Float[] StrikerStyleMotion = {0.27f, 0.2f, 0.22f, 0.25f, 0.27f, 0.2f, 0.2f, 0.22f, 0.6f, 0.66f,
            0.5f, 1.5f, 0.14f, 0.16f, 0.7f, 0.3f};
    String[] StrikerStyleNames = {"Draw Attack","Forward Thrusts","Upward Thrusts","Finisher Thrust (Forward)",
            "Finisher Thrust (Upward)","Thrust from Shield","Counter (Forward)","Counter (Upward)",
            "Counter (Counter Hit - Forward)","Counter (Counter Hit - Upward)","      - Full Charge",
            "      - Full Charge (Counter Hit)","Shield Smack - 27 KO","Running Charge (Per hit)",
            "     -Finisher","Jump Attack"};

    Float[] AerialStyleMotion = {0.27f, 0.2f, 0.22f, 0.45f, 0.2f, 0.2f, 0.2f, 0.22f, 0.6f, 0.66f,
            0.5f, 1.5f, 0.14f, 0.16f, 0.5f, 0.5f, 0.5f, 0.3f, 0.46f};
    String[] AerialStyleNames = {"Draw Attack","Forward Thrusts","Upward Thrusts","Strong Thrust (3 hits)",
            "Swipe","Thrust from Shield","Counter (Forward)","Counter (Upward)","Counter (Counter Hit - Forward)",
            "Counter (Counter Hit - Upward)","      - Full Charge","      - Full Charge (Counter Hit)",
            "Shield Smack - 27 KO","Running Charge (Per hit)","     -Finisher","     -Jumping Finisher",
            "     -Turn Around Finisher","Jump Attack","Aerial Attack after Vault (3 hits)"};

    Float[] AdeptStyleMotion = {0.27f, 0.2f, 0.22f, 0.45f, 0.2f, 0.2f,0.14f, 0.16f, 0.5f, 0.5f, 0.5f,
            0.3f, 0.45f};
    String[] AdeptStyleNames = {"Draw Attack","Forward Thrusts","Upward Thrusts","Strong Thrust (3 hits)",
            "Swipe","Thrust from Shield","Shield Smack - 27 KO","Running Charge (Per hit)",
            "     -Finisher","     -Jumping Finisher","     -Turn Around Finisher","Jump Attack",
            "Adept Counter (2 hits)"};


    Float[] ValorStyleMotion =  {0.27f, 0.2f, 0.22f, 0.45f, /*space*/0.2f, 0.2f, 0.5f,
            /*space*/0.2f, 0.22f, 0.6f, /*space*/0.66f, 0.5f, 1.5f, /*space*/0.2f, 0.16f, 0.5f,
            /*space*/0.5f, 0.5f, 0.3f};
    String[] ValorStyleNames = {"Draw Attack","Forward Thrusts","Upward Thrusts","Strong Thrust (3 hits)",
            "Swipe (Valor State)","Thrust from Shield","Valor Stance - Double Swipes (2 hits)",
            "Counter (Forward) (Valor State)","Counter (Upward) (Valor State)","Counter (Counter Hit - Forward)",
            "Counter (Counter Hit - Upward)","      - Full Charge","      - Full Charge (Counter Hit)",
            "Shield Smack - 27 KO","Running Charge (Per hit) (Valor State)","     -Finisher",
            "     -Jumping Finisher","     -Turn Around Finisher","Jump Attack"};


    Float[] AlchemyStyleMotion =  {0.27f, 0.2f, 0.22f, 0.45f, /*space*/0.2f,0.14f, 0.16f, 0.5f,
            /*space*/0.5f, 0.3f};
    String[] AlchemyStyleNames = {"Draw Attack","Forward Thrusts","Upward Thrusts","Strong Thrust (3 hits)",
            "Thrust from Shield","Shield Smack - 27 KO","Running Charge (Per hit)","     -Finisher",
            "     -Jumping Finisher","Jump Attack"};

    Float[] ShieldAssault = {0.1f, 0.1f, 0.3f, 0.5f};
    Float[] CorkscrewJab = {1.35f, 1.6f, 1.89f};
    Float[][] HunterArts = {ShieldAssault, CorkscrewJab};
    Float[] ChosenHunterArt;
    String[] HunterArtsLevelsSA = {"Start Up - 27, 27", "Run  (Per Hit) - 2, 3", "     -Natural Stop - 27, 27",
            "     -Finisher"};
    String[] HunterArtsLevelsCJ = {"Level I", "Level II", "Level III"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lance_calculation);
        ...
        NoEnragedGuardAura = (RadioButton) findViewById(R.id.NoEnragedGuardAura);
        EnragedGuardRed = (RadioButton) findViewById(R.id.EnragedGuardRed);
        EnragedGuardYellow = (RadioButton) findViewById(R.id.EnragedGuardYellow);
        EnragedGuardOrange = (RadioButton) findViewById(R.id.EnragedGuardOrange);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(ArtText.equals("Shield Assault")){
            getHunterArt("Shield Assault");
        }
        else if(ArtText.equals("Corkscrew Jab")) {
            getHunterArt("Corkscrew Jab");
        }
        ...
        Calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TextViewIDsAttacks = new String[]{"LAttack_1", "LAttack_2", "LAttack_3",
                        ...
                        "LAttack_8", "LAttack_9", "LAttack_10", "LAttack_11",
                        "LAttack_12", "LAttack_13", "LAttack_14", "LAttack_15",
                        "LAttack_16", "LAttack_17", "LAttack_18", "LAttack_19"};

                TextViewIDsNames = new String[]{"LAttack_1_Name", "LAttack_2_Name", "LAttack_3_Name",
                        "LAttack_4_Name", "LAttack_5_Name", "LAttack_6_Name", "LAttack_7_Name",
                        "LAttack_8_Name", "LAttack_9_Name", "LAttack_10_Name", "LAttack_11_Name",
                        "LAttack_12_Name", "LAttack_13_Name", "LAttack_14_Name", "LAttack_15_Name",
                        "LAttack_16_Name", "LAttack_17_Name", "LAttack_18_Name", "LAttack_19_Name"};

                AllTextViewIDs = new String[]{"LAttack_1_Name", "LAttack_2_Name", "LAttack_3_Name",
                        "LAttack_4_Name", "LAttack_5_Name", "LAttack_6_Name", "LAttack_7_Name",
                        "LAttack_8_Name", "LAttack_9_Name", "LAttack_10_Name", "LAttack_11_Name",
                        "LAttack_12_Name", "LAttack_13_Name", "LAttack_14_Name", "LAttack_15_Name",
                        "LAttack_16_Name", "LAttack_17_Name", "LAttack_18_Name", "LAttack_19_Name",
                        "LAttack_1", "LAttack_2", "LAttack_3", "LAttack_4", "LAttack_5", "LAttack_6",
                        "LAttack_7", "LAttack_8", "LAttack_9", "LAttack_10", "LAttack_11","LAttack_12",
                        "LAttack_13", "LAttack_14", "LAttack_15", "LAttack_16", "LAttack_17",
                        "LAttack_18", "LAttack_19"};
                ...
                if (!ChosenArt.equals("-None-")){
                    MotionCheck = 1;
                    if(ChosenArt.equals("Shield Assault")){
                        ChosenHunterArt = HunterArts[0];
                        HunterArtElementCheck = new int[] {1, 1, 1, 1};
                    }
                    else if(ChosenArt.equals("Corkscrew Jab")){
                        ChosenHunterArt = HunterArts[1];
                        HunterArtElementCheck = new int[] {3, 5, 7};
                    }
                }
                //-End-
                ...
                if(EnragedGuardRed.isChecked())
                    Skills.setEnragedGuardModifier(EnragedGuardRed.isChecked(), 1);
                else if(EnragedGuardYellow.isChecked())
                    Skills.setEnragedGuardModifier(EnragedGuardYellow.isChecked(), 2);
                else if(EnragedGuardOrange.isChecked())
                    Skills.setEnragedGuardModifier(EnragedGuardOrange.isChecked(), 3);
                else if(NoEnragedGuardAura.isChecked())
                    Skills.setEnragedGuardModifier(!NoEnragedGuardAura.isChecked(), 0);
                ...
                MonsterCalculation M;
                    ...
                    class.*/
                M = new MonsterCalculation(LanceCalculation.this,
                ...
                for (int i = 0; i < MotionGroup[MotionCheck].length; i++) {
                    if(SelectedStyle[i].contains("KO"))
                        M.alterHitzones(LanceCalculation.this, ChosenMonster, SelectedStyle[i], "", false);
                    M.getHitzones_Lance(LanceCalculation.this, ChosenElement, Skills, WeaknessExploitCheck.isChecked());
                    if(MotionCheck == 0){
                    ...
                    if (!ChosenArt.equals("-None-"))
                        ...
                        int HitMultiplier = 1;
                        if (SelectedStyle[i].contains("2 hits")) HitMultiplier = 2;
                    ...
                    if(MotionCheck == 0){
                        ...
                        if(ChosenArt.equals("Corkscrew Jab")){
                            textviews[i].setText(HunterArtsLevelsCJ[i]);
